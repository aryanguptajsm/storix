...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-bold transition-all duration-500 group overflow-hidden border border-transparent hover:border-primary/20 hover:bg-primary/5"
